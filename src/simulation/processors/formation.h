...
//
// Each member's own slot is written to `targets` (its local goal). All members
// also share one navigation anchor (the blob centroid), written to `nav_goal`
// (the global goal). Routing toward that single shared anchor means one flow
